                    ...
                    <div class="row left-indus-icons RWDpagescrollfix">
                        <div class="col-lg-5 col-md-5 col-sm-4 pr-0 icons">
                            <ul>
                                ...
                                <li><a href="https://mail.google.com/mail/u/1/#inbox"><span class="fas fa-envelope"></span></a></li>
                                <li><a href="#"><span class="fas fa-rss"></span></a></li>
                                <li><a href="https://twitter.com/home"><span class="fab fa-twitter"></span></a></li>
                            </ul>
                        </div>
                    ...
                    <div class="row footer-agile-grids ">
                        <div class="col-lg-4 col-md-4 col-sm-12 wthree-left-right">
                            ...
                            <div class="footer-icons">
                                <ul>
                                    <li class="mb-2">
                                        <a href="https://www.facebook.com/"><span class="fab fa-facebook-f"></span>
                                            <h6 class="ml-3 text-left">Facebook</h6>
                                        </a>

                                    </li>
                                    <li class="mb-2">
                                        <a href="mailto:hendifadlihanda@gmail.com"><span class="fas fa-envelope">
                                                <h6 class="ml-3 text-left">Gmail</h6>
                                            </span></a>
                                        <!-- <h6 class="ml-3 text-left">Gmail</h6> -->
                                    </li>
                                    <li class="mb-2">
                                        <a href="https://twitter.com/home"><span class="fab fa-twitter"></span>
                                            <h6 class="ml-3 text-left">Twitter</h6>
                                        </a>

                                    </li>
                                    <li class="mb-2">
                                        <a href="https://academy.babastudio.com/"><span class="fab fab fa-google-plus-g"></span>
                                            <h6 class="ml-3 text-right">Google+</h6>
                                        </a>

                                    </li>
                                    <li class="mb-2">
                                        <a href="https://www.instagram.com/"><span class="fab fab fa-instagram"></span>
                                            <h6 class="ml-3 text-right">Instagram</h6>
                                        </a>
